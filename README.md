...
- 🌏 **繁簡搜尋**：你打繁體、DB 簡體也找得到（zhconv 11,000+ 字，沒裝 fallback 手動 80 字）
...
- **4 個 tab**：
  - 🔍 搜尋：輸入中文（繁/簡自動轉換）→ 即時過濾 → 雙擊下載或加入佇列
    - **快捷分類按鈕**：全部 / 🎬電影 / 📺劇集 / 🎞️動漫 / 🎨文藝 / 📚紀錄 / 🎤演唱
    - **類型過濾下拉**：全部 / Movie / Series / Season / Episode
    - 搜尋 + 快捷 + 類型 三者可疊加
  - 📚 瀏覽全部：Folder（17 個）/ 類型 / 排序 / 多選批次
